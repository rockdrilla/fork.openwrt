...
HOST_OPT_FLAGS:=-march=x86-64-v2 -O3 -Wl,-s
...
HOST_CXXFLAGS:=-g $(HOST_OPT_FLAGS) $(HOST_CPPFLAGS)
HOST_CFLAGS:=-g $(HOST_OPT_FLAGS) $(HOST_CPPFLAGS)
HOST_LDFLAGS:=$(HOST_OPT_FLAGS) -L$(STAGING_DIR_HOST)/lib $(if $(IS_PACKAGE_BUILD),-L$(STAGING_DIR_HOSTPKG)/lib -L$(STAGING_DIR)/host/lib)
